...
*Ce guide correspond à Risk Analysis Editor version 1.10.0. Les captures illustrent l'analyse de démonstration fictive `examples/demo-aipd-sst.rae.json`.*
