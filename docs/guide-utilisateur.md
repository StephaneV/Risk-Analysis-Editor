...
- un **type** : oui/non, entier, décimal, date, texte, texte long, URL, e-mail, téléphone, texte contrôlé (regexp), liste déroulante, liste à cocher, **tags colorés** (choix unique ou multiple), **échelle** (niveaux à valeur numérique, exploitable dans des calculs — pastille colorée optionnelle) et **barre de progression** (0–100 %). Un champ peut aussi être une **référence à un objet** (voir §15) ;
