...
> Une **image** s'affiche en **vignette** dans les registres et le rapport **écran/PDF**. Dans l'export **Word**, une couleur donne une cellule teintée (et son hex) et une image apparaît comme marqueur `[image]` — l'embarquement des images dans le document Word n'est pas encore pris en charge.
