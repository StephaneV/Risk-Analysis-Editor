...
| [`demo-ebios-rm-information-system-enriched.rae.json`](demo-ebios-rm-information-system-enriched.rae.json) | 🇬🇧 en | **EBIOS RM**-inspired (ANSSI) & ISO 27005 | 12 risques · 11 mesures · 19 champs perso · **8 types d'objets, 46 objets** · rapport pré-paramétré |
...
| [`demo-dpia-ohs-enriched.rae.json`](demo-dpia-ohs-enriched.rae.json) | 🇬🇧 en | Risk-analysis part of a **DPIA**, inspired by the CNIL **PIA** method (GDPR art. 35) | 12 risques · 12 mesures · 19 champs perso · **7 types d'objets, 39 objets** · rapport pré-paramétré |
